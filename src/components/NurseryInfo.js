    ...
    <div class="container-footer">
      <div id="opening-hours" class="opening-hours-container">
        <div class="hours-adress-container">
          ...
          <span class="adress adress-chelsea">XXX Street, E8 2BB, London</span>
          <a
            class="google-maps-link"
      ...
      <div id="contact-us" class="container-contact">
        <div class="contact-us-container">
          ...
          <span class="contact-location contact-location-chelsea">Chelsea</span>
          <span class="phone-number phone-number-chelsea">+44 xxxxxxxxxx</span>
